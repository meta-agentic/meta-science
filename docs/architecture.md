...
The diagram is generated by [`scripts/architecture_diagram.py`](../scripts/architecture_diagram.py)
in the same palette as the demo video — deterministic, like everything else here.
