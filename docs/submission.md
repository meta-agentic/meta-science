...
An agent that runs real experiments on simulated worlds it has never seen — and upgrades
its own method only when a frozen benchmark proves the gain real. It can refuse itself.
