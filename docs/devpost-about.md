...
suggests method changes. Firestore holds the ledger of every verdict; Cloud Run
executes the runs. All of it declared in Terraform, with the API key in Secret Manager and a service account scoped
