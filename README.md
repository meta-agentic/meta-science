...
the API key in Secret Manager.

![meta-science architecture](docs/architecture.png)

The request path, the decision path, and the boundary between them — prose in
[docs/architecture.md](docs/architecture.md); the image is generated by
[`scripts/architecture_diagram.py`](scripts/architecture_diagram.py), deterministic
